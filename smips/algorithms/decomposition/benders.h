...
class Benders
{
  public:
    ...
    struct Bounds { double d_LB; double d_UB; bool d_infeasible; }; 
    ...
    Bounds hybrid_solve(double global_UB = GRB_INFINITY, bool affine = false, double tol = 1e-4, int max_iter = 100);

...
BendersCut Aggregator::zk_cut(Master::Solution sol, Master &master, bool lap_cuts, bool affine, size_t maxRounds, double tol)
{
  ...
  while (cRho > tol)
  {
    ...
    /*
     * A comment wrt paralellization and thread-safety of master.
     * Threads share the environment of master.d_cmodel. Functions that are called retrieve
     * the number of vars and cons, the basishead, and the result of a matrix operation
     */

...
void ZkTree::branch(size_t node_idx, vector<double> &lb_nodes, double &UB, double *x, double theta, Master &master, size_t maxRounds, bool gomory) 
{ 
  ...
  update_global_bounds(child_idx, lb_nodes, UB, x, theta, master, maxRounds, gomory);
}    